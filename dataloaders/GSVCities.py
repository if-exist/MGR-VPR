...
def get_GSVCities(args=None):
    img_per_place=4
    min_img_per_place=4
    image_size=tuple(getattr(args, "train_resize", (224, 224))) #(224, 224)     #image size for GSV-Cities
    cities=TRAIN_CITIES
    ...
    train_dataset = GSVCitiesDataset(
                ...
                base_path=getattr(args, "train_dataset_folder", None))
